...
This repo packages [Ride The Lightning](https://github.com/Ride-The-Lightning/RTL) for StartOS.
...
RTL runs the upstream `shahanafarooqui/rtl` image. To track a new upstream release:

1. Bump the image tag in `startos/manifest/index.ts` — `dockerTag: 'shahanafarooqui/rtl:v<new version>'`.
